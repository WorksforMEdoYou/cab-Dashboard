...
const Navbar = ({ setMenuVisible, userImage }) => (
  <div className="flex flex-wrap items-center px-6 py-4 gap-6 md:gap-10 bg-white shadow-md sticky top-0 z-10">
    ...
    <div className="flex items-center flex-shrink-0">
      ...
      <p className="text-xs font-bold ml-2 md:text-xl">Logoipsum</p>
    </div>
    ...
    <div className="flex items-center gap-4">
      ...
      <button className="md:hidden" onClick={() => setMenuVisible(prev => !prev)}>
